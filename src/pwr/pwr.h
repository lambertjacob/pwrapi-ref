...
int PWR_ObjAttrGetValues(PWR_Obj, int count, PWR_AttrName names[], void *vals,
                         PWR_Time ts[], PWR_Status);
int PWR_ObjAttrSetValues(PWR_Obj, int count, PWR_AttrName names[], void *vals,
                         PWR_Status);

int PWR_ObjAttrIsValid(PWR_Obj, PWR_AttrName);

int PWR_GrpAttrGetValue(PWR_Grp, PWR_AttrName, void *vals, PWR_Time ts[],
                        PWR_Status);
int PWR_GrpAttrSetValue(PWR_Grp, PWR_AttrName, void *val, PWR_Status);

int PWR_GrpAttrGetValues(PWR_Grp, int count, PWR_AttrName[], void *vals,
                         PWR_Time ts[], PWR_Status);
int PWR_GrpAttrSetValues(PWR_Grp, int count, PWR_AttrName[], void *vals,
                         PWR_Status);
...
int PWR_ObjGetStat(PWR_Obj, PWR_AttrName, PWR_AttrStat, PWR_TimePeriod *,
                   double *);
int PWR_GrpGetStats(PWR_Grp, PWR_AttrName, PWR_AttrStat, PWR_TimePeriod *,
                    double[], PWR_TimePeriod[]);
...
int PWR_GrpGetReduce(PWR_Grp, PWR_AttrName, PWR_AttrStat, PWR_AttrStat,
                     PWR_TimePeriod, int *index, double *val, PWR_TimePeriod *);
...
int PWR_GetReportByID(PWR_Cntxt, const char *id, PWR_ID, PWR_AttrName,
...
int PWR_ObjAttrGetValues_NB(PWR_Obj, int count, PWR_AttrName name[], void *buf,
                            PWR_Time[], PWR_Request);

int PWR_ObjAttrSetValues_NB(PWR_Obj, int count, PWR_AttrName name[], void *buf,
                            PWR_Request);
/*
 *  Utility Functions
 */
